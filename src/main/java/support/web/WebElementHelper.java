...
public class WebElementHelper {
    ...
    public static boolean isElementDisplayed(WebElement webElement) {
        return isElementDisplayed(webElement, ApplicationProperties.getInteger(WAIT_TIMEOUT_SHT));
    }
    ...
    public static void selectCustomComboBoxValue(WebDriver driver, WebElement combobox, String value) {
        ...
        new WebDriverWait(driver, ApplicationProperties.getInteger(WAIT_TIMEOUT_SHT)).until(d -> d.findElements(drpdwnItemLocator).size() != 0);
